defmodule Rumbl.VideoControllerTest do
  ...
  @valid_attrs %{url: "http://youtu.be", title: "vide", description: "a vid"}
  ...
  @tag login_as: "max"
  test "does not create video and render errors", %{conn: conn} do
  ...
  @tag login_as: "max"
  test "authorize actions against acces by other users", %{user: owner, conn: conn} do
